    ...
    <section id="features" className="relative min-h-screen bg-black px-4 md:px-6 py-20 pb-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto">
        ...
        <div ref={containerRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-2 md:gap-4 lg:gap-3 lg:h-[480px]">
          ...
          <div className="feature-card h-[400px] md:h-[450px] lg:h-full rounded-2xl md:rounded-[2rem] overflow-hidden relative group cursor-pointer border border-white/5 bg-[#101010]">
            <video
          ...
          <div className="feature-card h-[400px] md:h-[450px] lg:h-full bg-[#212121] rounded-2xl md:rounded-[2rem] p-6 md:p-8 flex flex-col justify-between border border-white/5 hover:bg-[#252525] transition-colors duration-300">
            <div>
